...
void RegisterGameClasses()
{
	...
	REGISTER_CLASS_BEGIN( CHouseEntrance )
		REGISTER_BASE_CLASS( CEntity )
		REGISTER_MEMBER_TAGGED_PTR( m_pSign, e )
		REGISTER_MEMBER_TAGGED_PTR( m_pLight, e/l )
	...
	REGISTER_CLASS_BEGIN( CSpider2 )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER( m_pWeb )
		REGISTER_MEMBER( m_pWeb1 )
		REGISTER_MEMBER( m_fSight )
		REGISTER_MEMBER( m_fSight1 )
	REGISTER_CLASS_END()
	...
	REGISTER_CLASS_BEGIN( CExplosiveBall )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER( m_moveData )
		REGISTER_MEMBER( m_nAITick )
		REGISTER_MEMBER( m_pBullet )
