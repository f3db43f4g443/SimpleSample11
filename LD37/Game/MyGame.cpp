...
void RegisterGameClasses()
{
	...
	REGISTER_CLASS_BEGIN( CPlayerWeaponShoot0 )
		...
		REGISTER_MEMBER( m_fShakePerFire )
		REGISTER_MEMBER( m_nShakeDuration )
	...
	REGISTER_CLASS_BEGIN( CBuildingChunk )
		REGISTER_BASE_CLASS( CChunkObject )
		REGISTER_MEMBER( m_pPrefab )
		REGISTER_MEMBER( m_nHpPerSize )
	REGISTER_CLASS_END()
	...
	REGISTER_CLASS_BEGIN( COperateableSpawner )
		REGISTER_BASE_CLASS( CEntity )
		REGISTER_BASE_CLASS( IOperateable )
		REGISTER_MEMBER( m_pPrefab )
		REGISTER_MEMBER( m_nSpawnCD )
		REGISTER_MEMBER( m_nRepairCD )
		REGISTER_MEMBER( m_fRange )
	REGISTER_CLASS_END()
	...
	REGISTER_CLASS_BEGIN( CLimbsCargo2 )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER( m_nType )
		REGISTER_MEMBER( m_pBullet )
		REGISTER_MEMBER( m_pEft )
	...
	REGISTER_CLASS_BEGIN( CArmPuncher )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER_TAGGED_PTR( m_pEft, eft )
		REGISTER_MEMBER_TAGGED_PTR( m_pEnd, end )
		REGISTER_MEMBER_TAGGED_PTR( m_pBulletEmitter, end/1 )
		REGISTER_MEMBER_TAGGED_PTR( m_pBulletEmitter1, end/2 )
		REGISTER_MEMBER( m_flyData )
		REGISTER_MEMBER( m_fWidth )
		REGISTER_MEMBER( m_fKillEftDist )
		REGISTER_MEMBER( m_fMaxLen )
	...
	REGISTER_CLASS_BEGIN( CManBlob )
		REGISTER_BASE_CLASS( CEntity )
		REGISTER_MEMBER_TAGGED_PTR( m_pBlob, eft )
		REGISTER_MEMBER( m_nSpawnCD )
		REGISTER_MEMBER( m_nLife )
		REGISTER_MEMBER( m_nFadeTime )
		REGISTER_MEMBER( m_fSize )
		REGISTER_MEMBER( m_fSize1 )
	REGISTER_CLASS_END()

	REGISTER_CLASS_BEGIN( CGolem )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER( m_moveData )
		REGISTER_MEMBER( m_nLife )
		REGISTER_MEMBER( m_fAIStepTimeMin )
		...
		REGISTER_MEMBER( m_nKnockbackTime )
		REGISTER_MEMBER( m_fKnockbackSpeed )
		REGISTER_MEMBER( m_nActionCD )
		REGISTER_MEMBER_TAGGED_PTR( m_p1, 1 )
	REGISTER_CLASS_END()

	REGISTER_CLASS_BEGIN( CRailSlider )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER( m_fSpeed )
		REGISTER_MEMBER( m_fGravity )
		REGISTER_MEMBER( m_nTime )
		REGISTER_MEMBER( m_nTime1 )
		REGISTER_MEMBER( m_fMaxChainLen )
		REGISTER_MEMBER( m_fChainSpeed )
		REGISTER_MEMBER_TAGGED_PTR( m_pChain, 1 )
		REGISTER_MEMBER( m_pObjPrefab )
		REGISTER_MEMBER( m_pBulletPrefab )
	REGISTER_CLASS_END()

	REGISTER_CLASS_BEGIN( CMechHand )
		REGISTER_BASE_CLASS( CEnemy )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[0], 0 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[1], 1 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[2], 2 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[3], 3 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[4], 4 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[5], 5 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[6], 6 )
		REGISTER_MEMBER_TAGGED_PTR( m_pParts[7], 7 )
		REGISTER_MEMBER_TAGGED_PTR( m_pEft, eft )
		REGISTER_MEMBER( m_pBullet )
	REGISTER_CLASS_END()
	...
	REGISTER_CLASS_BEGIN( CBulletEmitter )
		REGISTER_BASE_CLASS( CEntity )
		REGISTER_MEMBER( m_bBeginShutdown )
		REGISTER_MEMBER( m_pBullet )
		REGISTER_MEMBER( m_nTargetType )
		REGISTER_MEMBER( m_fTargetParam )
		REGISTER_MEMBER( m_fTargetParam1 )
		REGISTER_MEMBER( m_fTargetParam2 )
		REGISTER_MEMBER( m_fTargetParam3 )
		REGISTER_MEMBER( m_nMagCount )
		REGISTER_MEMBER( m_nFireCD )
		REGISTER_MEMBER( m_nFireInterval )
		REGISTER_MEMBER( m_nAmmoCount )
