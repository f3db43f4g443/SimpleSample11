...
bool HitTestPolygons( SHitProxyPolygon* a, SHitProxyPolygon* b, const CMatrix2D& transA, const CMatrix2D& transB, SHitTestResult* pResult )
{
	...
	for( int i1 = 0, i2 = 0;; )
	{
		...
		if( i1 < nVertices1 && i2 < nVertices2 )
		{
			...
			CVector2 edge2 = vertices1[m2] - vertices1[n2];
...
void CHitProxy::AddRect( const CRectangle& rect )
{
	CVector2 vertices[4] = {
		{ rect.x, rect.y },
	...
	AddPolygon( 4, vertices );
}

void CHitProxy::AddPolygon( uint32 nVertices, const CVector2* vertices )
{
