...
{
public:
	CCamera2D( void ) : m_nPriority( 0 ), bEnabled( true ), m_extraOfs( 0, 0 ), nMask( INVALID_32BITID )
	{SetSize(1280, 800); SetPosition(0, 0); SetViewport(0, 0, 0, 0);}
	CCamera2D(float width, float height) : m_nPriority( 0 ), bEnabled( true ), m_extraOfs( 0, 0 )
